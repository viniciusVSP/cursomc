...
public class CursomcApplication<S> implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cat1.getCategorias().addAll(Arrays.asList(p1,p2,p3));
		cat2.getCategorias().addAll(Arrays.asList(p2));
		...
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6, null);
